...
import RulesCarousel from "@/components/home/RulesCarousel";
    ...
    <div className={`min-h-screen w-full ${bgColor} ${textColor}`}>
      <div className="w-full h-full p-4 sm:p-6 lg:p-8 space-y-4 md:space-y-6 max-w-[1600px] mx-auto">
        <PageHeader
          ...
          subtitle="Current state, market context, and immediate actions"
        />

        <MotivationalQuote colorMode={colorMode} />
          ...
          >
            <Card className={`${cardBg} ${borderColor} border h-full`}>
              <div className="p-3 md:p-4 flex items-center gap-3 min-h-[72px] md:min-h-[96px]">
                <div
                  className={`p-2.5 md:p-3 rounded-lg ${
                    colorMode === "light" ? "bg-zinc-100" : "bg-zinc-700"
                  } text-zinc-500`}
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className={`${cardBg} ${borderColor} border`}>
              ...
              <div className="space-y-4">
                <RulesCarousel rules={homeData.rules} onAddRule={newRule} colorMode={colorMode} />
              </div>
            </Card>
              ...
              <div className="space-y-4">
                ...
                <div
                  className={`flex justify-between items-center p-3 rounded-md ${
                    colorMode === "light" ? "bg-zinc-50" : "bg-zinc-700"
                  }`}
                >
                  ...
                  <Table className={`min-w-full divide-y ${
                    ...
                    <Tbody className={`${cardBg} divide-y ${
                      ...
                      {homeData.recentTrades.map((trade) => (
                        ...
                        >
                          <Td>
                            {formatSimpleDate(trade.date)}
                          </Td>
                          <Td>
                        <Link
                          href={`/trades/${trade.id}`}
                          className={`${colorMode === "light" ? "text-zinc-500" : "text-zinc-400"} font-semibold hover:underline`}
                        >
                          {trade.symbol}
                        </Link>
                          </Td>
